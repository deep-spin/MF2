...
#MAX_FRAMES = 256  Default max frames for video processing
MAX_FRAMES = 64
...
def gemma3_inference(args, input_prompts, video_path=None, system_prompt=None, shuffle_frames=False, max_frames=None):
