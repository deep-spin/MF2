...
def internvl3_inference(args, input_prompts, video_path=None, system_prompt=None):
    ...
    if video_path:
        pixel_values, num_patches_list = load_video(video_path, num_segments=8, max_num=12) # max nums defines the tiles used!
